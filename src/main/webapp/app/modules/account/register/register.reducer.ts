...
// Actions
export const handleRegister = (username, email, password, firstName, lastName, langKey = 'fr') => ({
  type: ACTION_TYPES.CREATE_ACCOUNT,
  payload: axios.post('/register', { username, email, password, firstName, lastName, langKey }),
  meta: {
